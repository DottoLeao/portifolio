    ...
    <section id="stats" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 max-w-xl mx-auto px-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-10 sm:mb-16">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 hover:border-[#00ff88]/50 transition-all duration-300"
            >
              <stat.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#00ff88] mb-2 sm:mb-3" />
              <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-zinc-900 dark:text-white mb-0.5 sm:mb-1 font-mono">
                {stat.value}
              </p>
              <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mb-1 sm:mb-2 leading-tight">{stat.label}</p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800"
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 gap-2">
            <div>
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-zinc-900 dark:text-white mb-1">
          ...
          <div className="space-y-3 sm:space-y-4">
            {techData.map((tech, index) => (
              ...
              >
                ...
                <div className="h-2 sm:h-3 rounded-full bg-zinc-100 dark:bg-zinc-800 overflow-hidden">
                  <motion.div
          ...
          {/* Total */}
          <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
            <span className="text-zinc-500 dark:text-zinc-400 text-xs sm:text-sm">Total de horas</span>
